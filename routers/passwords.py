...
from schemas.password_schemas import CreatePasswordRequest, UpdatePasswordRequest, DeletePasswordRequest
...
async def delete_password(
    password_data: DeletePasswordRequest,
    current_user: User = Depends(get_current_user),
    password_service: PasswordService = Depends(),
):
    try:
        print("Deleting password with ID:", password_data.password_id)
        password_response = password_service.delete_password(password_id=password_data.password_id)
